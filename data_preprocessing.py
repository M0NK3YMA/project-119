...
import nltk
nltk.download('punkt')
# natural language toolkit( for preprocessing like token/....., removing repetitive words...stemming)
...
def stemming(words, ignore_words):
    stem_words=[]
    for word in words:
...
for intent in intents['intents']:
    ...
    if intent['tag'] not in classes:
        ...
        stem_words = stemming(words, ignore_words)
